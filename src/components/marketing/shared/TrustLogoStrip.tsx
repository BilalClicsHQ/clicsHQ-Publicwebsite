...
const COMPANIES = [
  { name: 'TNN',       src: '/images/companies/TNN.svg',       w: 114, h: 114, cls: 'h-10' },
  { name: 'Cyberbay',  src: '/images/companies/CyberBay.svg',  w: 159, h: 32,  cls: 'h-7'  },
  { name: 'Nyxlab',    src: '/images/companies/nyxLab.svg',    w: 198, h: 71,  cls: 'h-9'  },
  { name: 'Capexplan', src: '/images/companies/capexplan.svg', w: 180, h: 40,  cls: 'h-8'  },
]
